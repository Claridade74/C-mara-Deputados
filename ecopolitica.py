...
with col2:
    ...
    grafico_projetos_a_favor = alt.Chart(df_all).mark_line(color='cornflowerblue').encode(x='ano:N', y='Projetos A Favor: a favor').properties(height=300)
    grafico_projetos_contra = alt.Chart(df_all).mark_line(color='red').encode(x='ano:N', y='Projetos Contra: contra').properties(height=300)
